const disabledEvent: (e: UIEvent) => boolean = (e: UIEvent): boolean => {
...
export default class Preventer {
	...
	public static enable(doc: Document = document, win: any = window): void {
		...
		console.log(
			`%cThis is a browser feature intended for developers. If someone told you to copy and paste something here to enable a Labels feature or "hack" someone's account, it is a scam and will give them access to your Labels account.`,
			'font-size: 20px;'
		);
		console.log('%cSee Labels.com for more information.', 'font-size: 20px;');
